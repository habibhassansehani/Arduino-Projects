...
analogWrite(enA, 60); // Write The Duty Cycle 0 to 255 Enable Pin A for Motor1 Speed 
analogWrite(enB, 60); // Write The Duty Cycle 0 to 255 Enable Pin B for Motor2 Speed 
...
digitalRead(R_S);
Serial.println("right side IR Sensor=");
Serial.println(R_S);

digitalRead(L_S);
Serial.println("left side IR Sensor=");
Serial.println(L_S);
